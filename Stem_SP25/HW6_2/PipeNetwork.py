    ...
    def findFlowRates(self):
        ...
        def fn(q):
            ...
            for i in range(len(self.pipes)):
                self.pipes[i].Q = q[i]   # set volumetric flow rate from input argument q  # done
            ...
            L = self.getNodeFlowRates()    # call the getNodeFlowRates function of this class  # done
            ...
            L += self.getLoopHeadLosses()   # call the getLoopHeadLosses function of this class  # done
            return L
