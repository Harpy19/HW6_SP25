...
class Pipe():
    ...
    def V(self):
        ...
        '''
        self.vel = (self.Q / 1000.0) / self.A  # the average velocity is Q/A (be mindful of units)  # done
        return self.vel
    ...
    def Re(self):
        ...
        :return:
        '''
        self.reynolds = self.fluid.rho * self.V() * self.d / self.fluid.mu  # Re=rho*V*d/mu, be sure to use V() so velocity is updated.  # done
    ...
    def frictionHeadLoss(self):  # calculate headloss through a section of pipe in m of fluid
        ...
        hl = ff * (self.length / self.d) * (self.V()**2) / (2 * g)  # calculate the head loss in m of water  # done
        return hl
